...
public class AuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        String tokenJWT = extractTokenHeader(request);

        if(tokenJWT != null) {
            String username = authenticationService.tokenValidation(tokenJWT);
    ...
    public String extractTokenHeader(HttpServletRequest request) {
        ...
        if (authHeader == null || authHeader.isEmpty() || !authHeader.split(" ")[0].equals("Bearer")) {
            return null;
        }
